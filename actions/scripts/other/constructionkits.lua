...
function onUse(cid, item, fromPosition, itemEx, toPosition)
	...
	if fromPosition.x == CONTAINER_POSITION then
		...
		return TRUE
	elseif fromPosition.x == playerPos.x and fromPosition.y == playerPos.y and fromPosition.z == playerPos.z then
		doPlayerSendCancel(cid, "O kit de construção não pode estar abaixo de você.")
		return TRUE				
	else
