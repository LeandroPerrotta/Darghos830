...
------------------------------------------------ addon ------------------------------------------------
		elseif msgcontains(msg, 'second brotherhood addon') then
			if isPremium(cid) then
				if getPlayerItemCount(cid,6500) >= 100 and getPlayerItemCount(cid,5880) >= 100 then
...
------------------------------------------------ confirm yes ------------------------------------------------
		elseif msgcontains(msg, 'yes') and talk_state == 35 then
			talk_state = 0
			if ggetPlayerItemCount(cid,6500) >= 100 and getPlayerItemCount(cid,5880) >= 100 then
				addon = getPlayerStorageValue(cid,150009)
				if addon == -1 then
					if doPlayerTakeItem(cid,6500,100) and doPlayerTakeItem(cid,5880,100) == 0 then
						selfSay(addon_give)
