...
local node1 = keywordHandler:addKeyword({'yes'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'What city do you wish to live in? Quendor or Thorn?'})
	local node2 = node1:addChildKeyword({'quendor'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, townid = 1, destination = quendorTemple, text = 'The town of Quendor, eh? So what vocation do you wish to become? Sorcerer, druid, paladin or knight?'})
	...
	local node2 = node1:addChildKeyword({'thorn'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, townid = 4, destination = thornTemple, text = 'The town of Thorn, eh? So what vocation do you wish to become? Sorcerer, druid, paladin or knight?'})
		local node3 = node2:addChildKeyword({'sorcerer'}, StdModule.say, {npcHandler = npcHandler, voc = 1, onlyFocus = true, text = 'So, you wish to be a powerful magician? Are you sure about that? This decision is irreversible!'})
			node3:addChildKeywordNode(yesNode)
			node3:addChildKeywordNode(noNode)
		local node3 = node2:addChildKeyword({'druid'}, StdModule.say, {npcHandler = npcHandler, voc = 2, onlyFocus = true, text = 'Are you sure that a druid is what you wish to become? This decision is irreversible!'})
